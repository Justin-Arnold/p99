	...
	return []commandSpec{
		{
			...
			Flags: []flagSpec{
				...
				{Long: "request-spec", TakesValue: true, Description: "YAML or JSON request spec for weighted traffic."},
				{Long: "base-url", TakesValue: true, Description: "Override request spec base_url."},
				{Long: "seed", TakesValue: true, Description: "Seed for request spec randomization."},
			},
		},
		{
			Name:    "watch",
		...
		},
		{
			...
			Flags: []flagSpec{
				...
				{Long: "probe-spec", TakesValue: true, Description: "YAML or JSON request spec to probe during capture."},
				{Long: "probe-base-url", TakesValue: true, Description: "Override probe request spec base_url."},
				{Long: "seed", TakesValue: true, Description: "Seed for probe request spec randomization."},
				{Long: "runtime", TakesValue: true, Description: "Go runtime base URL for correlation."},
				{Long: "runtime-timeout", TakesValue: true, Description: "Runtime endpoint timeout."},
			},
		},
